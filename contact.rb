...
eli.first_name = "Eli"
eli.last_name = "James"
#puts eli.first_name + " " + eli.last_name
puts eli.to_s
puts eli.to_s('full_name')
puts eli.to_s('last_first')


joshua = Contact.new
joshua.first_name = "Joshua"
joshua.middle_name = "A"
...
#puts joshua.to_s
puts joshua.to_s('full_name')
#puts joshua.to_s('last_first')
joshua.print_phone_numbers
joshua.print_addresses
=end